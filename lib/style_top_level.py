...
class View_style_top_level(CTkToplevel):
    def __init__(self, main_data, pos_data):
        ...
        for po in self.pos_data:
            Po_data_panel(parent=self, data= po)
...
class Po_data_panel(CTkFrame):
    def __init__(self, parent, data):
        ...
        # layout
        self.container.columnconfigure(tuple(range(24)), weight=1, uniform="a")
        self.container.rowconfigure(tuple(range(self.data_rows + self.header_rows)), weight=1, uniform="a")
    ...
    def create_po_header_widgets(self):
        ...
        # po headers
        Simple_label(self.container, text="Style#", column=0, row=1, colspan=2, font=TABLE_HEADER_FONT)
        Simple_label(self.container, text="SMU", column=2, row=1, font=TABLE_HEADER_FONT)
        Simple_label(self.container, text="Size Range", column=3, row=1, colspan=2, font=TABLE_HEADER_FONT)
        Simple_label(self.container, text="Ratio", column=5, row=1, colspan=2, font=TABLE_HEADER_FONT)
        Simple_label(self.container, text="Team", column=7, row=1, colspan=2, font=TABLE_HEADER_FONT)
        Simple_label(self.container, text="Color Code", column=9, row=1, colspan=2, font=TABLE_HEADER_FONT)
        Simple_label(self.container, text="Piece 1 Color", column=11, row=1, colspan=2, font=TABLE_HEADER_FONT)
        Simple_label(self.container, text="Piece 2 Color", column=13, row=1, colspan=2, font=TABLE_HEADER_FONT)
        Simple_label(self.container, text="Color QTY", column=15, row=1, colspan=2, font=TABLE_HEADER_FONT)
        Simple_label(self.container, text="PO Total QTY", column=17, row=1, colspan=2, font=TABLE_HEADER_FONT)
        Simple_label(self.container, text="Price", column=19, row=1, colspan=2, font=TABLE_HEADER_FONT)
        Simple_label(self.container, text="Shipping Date", column=21, row=1, colspan=2, font=TABLE_HEADER_FONT)
